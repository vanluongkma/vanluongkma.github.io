...
![image](https://hackmd.io/_uploads/ryW1Q_0sp.png)

 - 2 ví dụ về đường cong elliptic

![image](https://hackmd.io/_uploads/Hyy3j3e2a.png)
...
### Đường cong Elliptic trên trường hữu hạn
 - Xét trường hữu han $F_q$ của $q = p^r$ phần tử trên trường hữu hạn $K$. Giả sửu $E$ là đường cong E được định nghĩa trên $F_q$.Nếu đặc số của trường $p=2$ hoặc $p=3$ thì $E$ được cho bởi phương trình ![image](https://hackmd.io/_uploads/BkYo2bZ3p.png)
 và ![image](https://hackmd.io/_uploads/Hyqn2Zbhp.png)
 ...
 - Ví dụ : Nếu $q = p$ là 1 số nguyên tố thì $λ(x) = (x / p)$ là kí hiệu Legedre Symbol. Do đó trong tất cả mọi trường hợp số các nghiệm $y \in F_q$ thảo mãn phương trình $y^2=u$ là bằng $1+ λ(u)$. Vì vậy số các nghiệm ở phương trình 1 và điểm vô hạn là: ![image](https://hackmd.io/_uploads/SyUP1MWn6.png)

 - Giả sử $λ(x^3 + ax + b) = +-1$
 - Lấy tổng ngẫu nhiên ta thấy rằng ![image](https://hackmd.io/_uploads/rkxkeM-n6.png) bị chặn bở $2 \sqrt q$ đó chính là định lý Hasses được phát triển như sau:
...
![image](https://hackmd.io/_uploads/H1a8aPe3p.png)
...
![image](https://hackmd.io/_uploads/B1SvcOE2a.png)
...
![image](https://hackmd.io/_uploads/rkBplR43p.png)
...
[3] https://risencrypto.github.io/WeilMOV/

[4] https://en.wikipedia.org/wiki/Baby-step_giant-step

[5] https://en.wikipedia.org/wiki/Pohlig%E2%80%93Hellman_algorithm

[6] https://ariana1729.github.io/2021/05/31/SmartAttack.html
...
[9] https://en.wikipedia.org/wiki/Elliptic-curve_Diffie%E2%80%93Hellman